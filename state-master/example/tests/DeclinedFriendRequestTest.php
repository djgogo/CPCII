<?php
class DeclinedFriendRequestTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var FriendRequest
     */
    ...
    {
        $this->friendrequest = new FriendRequest(new DeclinedFriendRequestState);
    }
     ...
     * @covers DeclinedFriendRequestState::delete
